...
var _user$project$Store$view = function (model) {
	return A2(
			...
			case 'Increment':
				...
				return {
					...
					_1: _user$project$Store$nextState(
						_user$project$Store$encodeModel(newModel))
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{value: model.value - 1}),
					_1: _user$project$Store$nextState(
						_user$project$Store$encodeModel(model))
				};
		}
	});
var _user$project$Store$dispatch = _elm_lang$core$Native_Platform.incomingPort('dispatch', _elm_lang$core$Json_Decode$int);
...
var _user$project$Store$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Store$increment(
				_elm_lang$core$Basics$always(_user$project$Store$Increment))
			]));
};
var _user$project$Store$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Store$init, view: _user$project$Store$view, update: _user$project$Store$update, subscriptions: _user$project$Store$subscriptions})
};
var _user$project$Store$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Store'] = Elm['Store'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Store'], 'Store', typeof _user$project$Store$main === 'undefined' ? null : _user$project$Store$main);
